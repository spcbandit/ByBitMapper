...
{
    /// <summary>
    ///  Коллекция объектов InstrumentInfoSnapshotData
    /// </summary>
    public sealed class InstrumentInfoSnapshotData
    {
        [JsonConstructor]
        public InstrumentInfoSnapshotData(long id, string symbol, decimal lastPriceE4, decimal lastPrice, string lastTickDirection, 
            decimal prevPrice24hE4, decimal prevPrice24h, decimal price24hPcntE6, decimal highPrice24hE4, decimal highPrice24h, 
            decimal lowPrice24hE4, decimal lowPrice24h, decimal prevPrice1hE4, decimal prevPrice1h, decimal price1hPcntE6, 
            decimal markPriceE4, decimal markPrice, decimal indexPriceE4, decimal indexPrice, decimal openInterestE8, 
            decimal totalTurnoverE8, decimal turnover24hE8, decimal totalVolumeE8, decimal volume24hE8, decimal fundingRateE6, 
            decimal predictedFundingRateE6, decimal crossSeq, DateTime createdAt, DateTime updatedAt, DateTime nextFundingTime, 
            decimal countDownHour, decimal bid1PriceE4, decimal ask1PriceE4, decimal bid1Price, decimal ask1Price)
        {
            Id = id;
            Symbol = symbol;
