...
namespace BybitMapper.Perpetual.RestV2.Responses
{
    public sealed class APIKeyInfoResponse
    {
        /// <summary>
        /// USDT Perpetual Респонс : APIKeyInfoResponse
        /// </summary>
        [JsonConstructor]
        public APIKeyInfoResponse(int retCode, string retMessage, string extCode, string extInfo, double timestamp,
            double rateLimitStatus, double rateLimitResetMs, double rateLimit, IReadOnlyList<APIKeyInfoData> result)
        {
            RetCode = retCode;
        ...
        [JsonProperty("result")]
        public IReadOnlyList<APIKeyInfoData> Result { get; }
    }
