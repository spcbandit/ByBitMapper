...
{
    /// <summary>
    /// USDT Perpetual класс для парсинга response CancelAllActiveOrders
    /// </summary>
    public sealed class CancelAllActiveOrdersResponse
    {
        [JsonConstructor]
        public CancelAllActiveOrdersResponse(int retCode, string retMessage, string extCode, string extInfo, double timestamp,
