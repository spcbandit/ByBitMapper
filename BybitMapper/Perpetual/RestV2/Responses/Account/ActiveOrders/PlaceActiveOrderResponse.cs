...
{
    /// <summary>
    /// USDT Perpetual класс для парсинга response PlaceActiveOrder
    /// </summary>
    public sealed class PlaceActiveOrderResponse
    {
        [JsonConstructor]
        public PlaceActiveOrderResponse(int retCode, string retMessage, string extCode, string extInfo, double timestamp, 
            double rateLimitStatus, double rateLimitResetMs, double rateLimit, PlaceActiveOrderData result)
        {
            RetCode = retCode;
        ...
        [JsonProperty("result")]
        public PlaceActiveOrderData Result { get; }
    }
}
