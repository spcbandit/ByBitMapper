...
{
    /// <summary>
    /// USDT Perpetual класс для парсинга response  MyLastFundingFee
    /// </summary>
    public sealed class MyLastFundingFeeResponse
    {
        [JsonConstructor]
        public MyLastFundingFeeResponse(int retCode, string retMessage, string extCode, string extInfo, double timestamp,
            double rateLimitStatus, double rateLimitResetMs, double rateLimit, IReadOnlyList<MyLastFundingFeeData> result)
        {
            RetCode = retCode;
        ...
        [JsonProperty("result")]
        public IReadOnlyList<MyLastFundingFeeData> Result { get; }
    }
}
