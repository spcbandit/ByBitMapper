...
{
    public class PositionModeSwitchResponse
    {
        [JsonConstructor]
        public PositionModeSwitchResponse(int retCode, string retMessage, string extCode, string extInfo, double timestamp,
            double rateLimitStatus, double rateLimitResetMs, double rateLimit)
        {
            RetCode = retCode;
