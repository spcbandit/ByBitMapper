...
{
    /// <summary>
    /// USDT Perpetual класс для парсинга response AddReduceMargin
    /// </summary>
    public sealed class AddReduceMarginResponse
    {
        [JsonConstructor]
        public AddReduceMarginResponse(int retCode, string retMessage, string extCode, string extInfo, double timestamp,
            double rateLimitStatus, double rateLimitResetMs, double rateLimit, AddReduceMarginData result)
        {
            RetCode = retCode;
        ...
        [JsonProperty("result")]
        public AddReduceMarginData Result { get; }
    }
}
