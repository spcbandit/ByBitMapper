...
{
    /// <summary>
    /// USDT Perpetual класс для парсинга response ClosedProfitLoss
    /// </summary>
    public sealed class ClosedProfitLossResponse
    {
        [JsonConstructor]
        public ClosedProfitLossResponse(int retCode, string retMessage, string extCode, string extInfo, double timestamp,
            double rateLimitStatus, double rateLimitResetMs, double rateLimit, ClosedProfitLossData result)
        {
            RetCode = retCode;
        ...
        [JsonProperty("result")]
        public ClosedProfitLossData Result { get; }
    }
}
