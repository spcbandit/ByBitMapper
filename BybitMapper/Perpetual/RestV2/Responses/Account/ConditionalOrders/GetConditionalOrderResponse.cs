...
{
    /// <summary>
    /// USDT Perpetual класс для парсинга response GetConditionalOrder
    /// </summary>
    public sealed class GetConditionalOrderResponse
    {
        [JsonConstructor]
        public GetConditionalOrderResponse(int retCode, string retMessage, string extCode, string extInfo, double timestamp,
            double rateLimitStatus, double rateLimitResetMs, double rateLimit, GetConditionalOrderData result)
        {
            RetCode = retCode;
        ...
        [JsonProperty("result")]
        public GetConditionalOrderData Result { get; }
    }
}
