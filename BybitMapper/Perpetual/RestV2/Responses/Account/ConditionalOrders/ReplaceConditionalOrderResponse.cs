...
{
    /// <summary>
    /// USDT Perpetual класс для парсинга response  ReplaceConditionalOrder
    /// </summary>
    public sealed class ReplaceConditionalOrderResponse
    {
        [JsonConstructor]
        public ReplaceConditionalOrderResponse(int retCode, string retMessage, string extCode, string extInfo, double timestamp,
