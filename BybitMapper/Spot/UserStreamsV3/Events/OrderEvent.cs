...
namespace BybitMapper.Spot.UserStreamsV3.Events
{
    ...
    public class OrderEvent : BaseEvent
    {
        ...
        public OrderEvent(string type, string topic, string ts, IReadOnlyList<OrderData> data) :
            base(type, topic, ts)
        {
            Data = data;
        }
    ...
    {
        [JsonConstructor]
        public OrderData(string eventType, long eventTime, string tradingPair, string userGeneratedOrderId,
