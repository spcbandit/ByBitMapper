...
namespace BybitMapper.Spot.RestV1.Responses.Account
{
    ...
    {
        [JsonConstructor]
        public TradeHistoryResponse(int? retCode, string retMessage, string extCode, object extInfo, IReadOnlyList<TradeHistoryData> result)
        {
            RetCode = retCode;
        ...
        [JsonProperty("result")]
        public IReadOnlyList<TradeHistoryData> Result { get; }
    }
}
