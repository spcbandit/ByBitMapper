...
namespace BybitMapper.InversePerpetual.RestV2.Responses.Account.ConditionalOrders
{
    ...
    {
        [JsonConstructor]
        public GetConditionalOrderResponse(int retCode, string retMessage, string extCode, string extInfo, double timestamp, double rateLimitStatus, double rateLimitResetMs, double rateLimit, GetConditionalOrderData result)
        {
            RetCode = retCode;
