...
{
    public sealed class ReplaceConditionalResponse
    {
        [JsonConstructor]
        public ReplaceConditionalResponse(int retCode, string retMessage, string extCode, string extInfo, double timestamp, double rateLimitStatus, double rateLimitResetMs, double rateLimit, ReplaceConditionalData result)
        {
            RetCode = retCode;
        ...
        public ReplaceConditionalData Result { get; }
    }
}
