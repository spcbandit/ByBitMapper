...
namespace BybitMapper.InversePerpetual.RestV2.Responses.Account.ActiveOrders
{
    ...
    {
        [JsonConstructor]
        public CancelActiveOrderResponse(int retCode, string retMessage, string extCode, string extInfo, double timestamp, double rateLimitStatus, double rateLimitResetMs, double rateLimit, CancelOrderData result)
        {
            RetCode = retCode;
        ...
        [JsonProperty("result")]
        public CancelOrderData Result { get; }
    }
}
