...
namespace BybitMapper.InversePerpetual.RestV2.Responses.Account.ActiveOrders
{
    ...
    {
        [JsonConstructor]
        public ReplaceActiveOrderResponse(int retCode, string retMessage, string extCode, string extInfo, double timestamp, double rateLimitStatus, double rateLimitResetMs, double rateLimit, ReplaceActiveOrderData result)
        {
            RetCode = retCode;
        ...
        public ReplaceActiveOrderData Result { get; }
    }
}
