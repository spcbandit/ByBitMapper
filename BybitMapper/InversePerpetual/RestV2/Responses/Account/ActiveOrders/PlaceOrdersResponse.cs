...
{
    public sealed class PlaceOrdersResponse
    {
        [JsonConstructor]
        public PlaceOrdersResponse(int retCode, string retMessage, string extCode, string extInfo, double timestamp, double rateLimitStatus, double rateLimitResetMs, double rateLimit, PlaceOrderData result)
        {
            RetCode = retCode;
