...
{
    public sealed class CancelAllOrdersResponse
    {
        [JsonConstructor]
        public CancelAllOrdersResponse(int retCode, string retMessage, string extCode, string extInfo, double timestamp, double rateLimitStatus, double rateLimitResetMs, double rateLimit, IReadOnlyList<CancelAllOrdersData> result)
        {
            RetCode = retCode;
        ...
        [JsonProperty("result")]
        public IReadOnlyList<CancelAllOrdersData> Result { get; }
    }
}
