...
namespace BybitMapper.InversePerpetual.RestV2.Responses.Account.Funding
{
    public sealed class PredictedFundingRateResponse
    {
        [JsonConstructor]
        public PredictedFundingRateResponse(int retCode, string retMessage, string extCode, string extInfo, double timestamp, double rateLimitStatus, double rateLimitResetMs, double rateLimit, PredictedFundingData result)
        {
            RetCode = retCode;
        ...
        public PredictedFundingData Result { get; }
    }
}
