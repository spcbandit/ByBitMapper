...
namespace BybitMapper.InversePerpetual.RestV2.Responses.Account.Funding
{
    ...
    {
        [JsonConstructor]
        public GetLastFundingRateResponse(int retCode, string retMessage, string extCode, string extInfo, double timestamp, double rateLimitStatus, double rateLimitResetMs, double rateLimit, LastFundingRateData result)
        {
            RetCode = retCode;
        ...
        public LastFundingRateData Result { get; }
    }
}
