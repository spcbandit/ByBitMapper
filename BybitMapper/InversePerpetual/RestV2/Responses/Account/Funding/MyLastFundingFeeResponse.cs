...
namespace BybitMapper.InversePerpetual.RestV2.Responses.Account.Funding
{
    ...
    {
        [JsonConstructor]
        public MyLastFundingFeeResponse(int retCode, string retMessage, string extCode, string extInfo, double timestamp, double rateLimitStatus, double rateLimitResetMs, double rateLimit, MyLastFundingRateData result)
        {
            RetCode = retCode;
        ...
        public MyLastFundingRateData Result { get; }
    }
}
