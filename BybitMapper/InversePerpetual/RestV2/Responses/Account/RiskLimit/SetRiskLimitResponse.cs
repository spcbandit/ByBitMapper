...
namespace BybitMapper.InversePerpetual.RestV2.Responses.Account.RiskLimit
{
    ...
    {
        [JsonConstructor]
        public SetRiskLimitResponse(int retCode, string retMessage, string extCode, string extInfo, double timestamp, double rateLimitStatus, double rateLimitResetMs, double rateLimit, SetRiskLimitData result)
        {
            RetCode = retCode;
