...
namespace BybitMapper.InversePerpetual.RestV2.Responses.Account.Positions
{
    ...
    {
        [JsonConstructor]
        public MyPositionResponse(int retCode, string retMessage, string extCode, string extInfo, double timestamp, double rateLimitStatus, double rateLimitResetMs, double rateLimit, object result)
        {
            RetCode = retCode;
        ...
        public MyPositionData ResultObject { get { return new BaseJsonHandler<MyPositionData>().HandleSingle(Result.ToString()); } }
