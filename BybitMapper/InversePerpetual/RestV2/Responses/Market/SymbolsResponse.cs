...
namespace BybitMapper.InversePerpetual.RestV2.Responses.Market
{
    ...
    {
        [JsonConstructor]
        public SymbolsResponse(int retCode, string retMessage, string extCode, string extInfo, double timestamp, IReadOnlyList<SymbolData> result)
        {
            RetCode = retCode;
        ...
        public IReadOnlyList<SymbolData> Result { get; }
    }
}
