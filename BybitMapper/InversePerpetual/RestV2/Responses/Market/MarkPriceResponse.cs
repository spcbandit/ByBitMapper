...
{
    public sealed class MarkPriceResponse
    {
        [JsonConstructor]
        public MarkPriceResponse(int retCode, string retMessage, string extCode, string extInfo, double timestamp, IReadOnlyList<MarkPriceKlineData> result)
        {
            RetCode = retCode;
        ...
        public IReadOnlyList<MarkPriceKlineData> Result { get; }
    }
}
