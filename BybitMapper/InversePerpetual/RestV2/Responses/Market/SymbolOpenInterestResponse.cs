...
{
    public sealed class SymbolOpenInterestResponse
    {
        [JsonConstructor]
        public SymbolOpenInterestResponse(int retCode, string retMessage, string extCode, string extInfo, double timestamp, IReadOnlyList<SymbolOpenInterestData> result)
        {
            RetCode = retCode;
        ...
        public IReadOnlyList<SymbolOpenInterestData> Result { get; }
    }
}
