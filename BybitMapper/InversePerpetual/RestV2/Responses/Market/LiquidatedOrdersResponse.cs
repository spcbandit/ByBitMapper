...
namespace BybitMapper.InversePerpetual.RestV2.Responses.Market
{
    ...
    {
        [JsonConstructor]
        public LiquidatedOrdersResponse(int retCode, string retMessage, string extCode, string extInfo, double timestamp, IReadOnlyList<LiquidatedOrderData> result)
        {
            RetCode = retCode;
        ...
        public IReadOnlyList<LiquidatedOrderData> Result { get; }
    }
}
