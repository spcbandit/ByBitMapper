...
{
    public sealed class TradingRecordsResponse
    {
        [JsonConstructor]
        public TradingRecordsResponse(int retCode, string retMessage, string extCode, string extInfo, double timestamp, IReadOnlyList<TradingRecordsData> result)
        {
            RetCode = retCode;
        ...
        public IReadOnlyList<TradingRecordsData> Result { get; }
    }
}
