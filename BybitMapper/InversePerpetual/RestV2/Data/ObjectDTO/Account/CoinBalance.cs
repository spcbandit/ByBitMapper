...
using BybitMapper.InversePerpetual.RestV2.Converters;
...
namespace BybitMapper.InversePerpetual.RestV2.Data.ObjectDTO.Account
{
    ...
    {
        [JsonConstructor]
        public CoinBalance(decimal equity, decimal availableBalance, decimal usedMargin, decimal orderMargin, decimal positionMargin, decimal occClosingFee, decimal occFundingFee, decimal walletBalance, decimal realisedPnl, decimal unrealisedPnl, decimal cumRealisedPnl, decimal givenCash, decimal serviceCash)
        {
            Equity = equity;
