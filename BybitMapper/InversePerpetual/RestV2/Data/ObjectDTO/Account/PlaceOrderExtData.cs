...
{
    public sealed class PlaceOrderExtData
    {
        [JsonConstructor]
        public PlaceOrderExtData(string userId, string orderId, string symbol, string side, string type, decimal leavesValue, decimal price, decimal qty, string timeInForce, string orderStatus, decimal leavesQty, decimal cumExecQty, decimal cumExecValue, decimal cumExecFee, string rejectReason, string orderLinkId, DateTime? createdAt, DateTime? updatedAt)
        {
            UserId = userId;
            OrderId = orderId;
            Symbol = symbol;
        ...
        //public ExtFieldsData ExtFields { get; } 
